...
${DATE2B}=Evaluate          datetime.datetime(2014,4,24,22,45,12)
${DATE3}=Evaluate           datetime.datetime(2015,10,25)
${DATE3B}=Evaluate          datetime.datetime(2015,10,26)
...
Time addition to date over DST boundary
    ...
    ${DATE3}    ${DELTA1}    ${DATE3B}    result_format=datetime
