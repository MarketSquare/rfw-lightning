...
Run Keyword If All Critical Tests Passed Can't be Used In Test
    ...
    Run Keyword If All Critical Tests Passed    Fail    ${NON_EXISTING}    #Should not be executed nor evaluated
...
Run Keyword If Any Critical Tests Failed Can't be Used In Test
    ...
    Run Keyword If Any Critical Tests Failed    Fail    ${NON_EXISTING}    #Should not be executed nor evaluated
...
Run Keyword If All Tests Passed Can't be Used In Test
    ...
    Run Keyword If All Tests Passed    Fail    ${NON_EXISTING}    #Should not be executed nor evaluated
...
Run Keyword If Any Tests Failed Can't be Used In Test
    ...
    Run Keyword If Any Tests Failed    Fail    ${NON_EXISTING}    #Should not be executed nor evaluated
