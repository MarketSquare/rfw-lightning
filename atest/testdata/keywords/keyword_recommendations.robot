...
Implicit Keyword Similar To Keyword In Imported Library
    ...
    ...    $INDENTRecLibrary1.Keyword Only In Library 1
    ...    $INDENTRec Library 2 With Custom Name.Keyword Only In Library 2
...
Explicit Keyword Similar To Keyword In Imported Resource
    ...
    ...    $INDENTrecommendation_resource_1.Keyword Only In Resource 1
    ...    $INDENTrecommendation_resource_2.Keyword Only In Resource 2
    ...    $INDENTrecommendation_resource_1.Keyword In Both Resources
    ...    $INDENTrecommendation_resource_2.Keyword In Both Resources
...
Wrapped By Run Keyword Implicit Missing Similar To Both Libraries
    ...
    ...    $INDENTRec Library 2 With Custom Name.Keyword In Both Libraries
    ...    $INDENTRecLibrary1.Keyword In Both Libraries
...
Similar User Keywords
    ...
    ...    $INDENTSimilar User Keyword 3
    ...    $INDENTSimilar User Keyword 2
    ...    $INDENTSimilar User Keyword 1
...
Similar Keywords In Resources And Libraries
    ...
    ...    $INDENTSimilar Kw 5
    ...    $INDENTRec Library 2 With Custom Name.Similar Kw 4
    ...    $INDENTRecLibrary1.Similar Kw 3
    ...    $INDENTrecommendation_resource_2.Similar Kw 2
    ...    $INDENTrecommendation_resource_1.Similar Kw 1
    Similar Kw
...
BuiltIn Similar To Other BuiltIns
    ...
    ...    $INDENTRecLibrary1.Action And Ignore Problems
...
Similar To Really Long Keyword
    ...
    ...    $INDENTReally Long Keyword That Does Not End For Quite A While
...
Explicit Many Similar Keywords
    ...
    ...    $INDENTRecLibrary1.Get Data
    ...    $INDENTRecLibrary1.Read Data
    ...    $INDENTRecLibrary1.Update Data
    ...    $INDENTRecLibrary1.Modify Data
    ...    $INDENTRecLibrary1.Delete Data
    ...    $INDENTRecLibrary1.Create Data
