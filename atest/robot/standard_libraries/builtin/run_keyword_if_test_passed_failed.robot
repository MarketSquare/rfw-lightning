...
Variable Values Should Not Be Visible As Keyword's Arguments
    ...
    Check Keyword Data    ${tc.teardown}    BuiltIn.Run Keyword If Test Failed    args=Teardown UK, \${TEARDOWN_MESSAGE}    type=TEARDOWN
    Check Keyword Data    ${tc.teardown.kws[0]}    Teardown UK    args=\${TEARDOWN_MESSAGE}
    Check Keyword Data    ${tc.teardown.kws[0].kws[0]}    BuiltIn.Log    args=\${message}
