...
Import Library Normally Before Importing With Name In Another Suite
    ...
    Syslog Should Contain    Imported library 'OperatingSystem' with arguments [ ] (version ${ROBOT_VERSION}, class type, GLOBAL scope,
...
Global Scope
    Check Test Case    ${TEST_NAME} 1.1
    Check Test Case    ${TEST_NAME} 1.2
    Check Test Case    ${TEST_NAME} 2.1
    Check Test Case    ${TEST_NAME} 2.2
