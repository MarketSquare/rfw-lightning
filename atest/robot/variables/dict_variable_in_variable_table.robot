...
Invalid syntax
    ...
    Error In File    1    variables/dict_variable_in_variable_table.robot    17
    ...    Setting variable '\&{BAD_SYNTAX_2}' failed:
...
Non-dict cannot be used as dict variable
    ...
    Error In File    3    variables/dict_variable_in_variable_table.robot    35
    ...    Setting variable '\&{NON_DICT_DICT_2}' failed:
    ...    Value of variable '\&{SPACE}' is not dictionary or dictionary-like.
    Error In File    4    variables/dict_variable_in_variable_table.robot    36
    ...    Setting variable '\&{NON_DICT_DICT_3}' failed:
    ...    Value of variable '\&{EMPTY_DICT.keys()}' is not dictionary or dictionary-like.
