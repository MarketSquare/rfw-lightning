...
Failure When Parsing Any Data Source Fails
    ...
    ${NON_EXISTING_PATH} =    Normalize Path    ${DATADIR}/nönex
    Stderr Should Contain    [ ERROR ] Parsing '${NON_EXISTING_PATH}' failed: File or directory to execute does not exist.
...
Warnings And Error When Parsing All Data Sources Fail
    ...
    ${NON_EXISTING_PATH} =    Normalize Path    ${DATADIR}/nönex
    Stderr Should Contain    [ ERROR ] Parsing '${NON_EXISTING_PATH}1' and '${NON_EXISTING_PATH}2' failed: File or directory to execute does not exist.
