...
Verify override message
    ...
    $std_imported_as =    Set Variable If    "$std_with_name"    $SPACEimported as '$std_with_name'    $EMPTY
    $ctm_imported_as =    Set Variable If    "$ctm_with_name"    $SPACEimported as '$ctm_with_name'    $EMPTY
