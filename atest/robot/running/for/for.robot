...
Indentation is not required
    ${loop} =    Check test and get loop    ${TEST_NAME}    1
    Should be FOR loop    ${loop}    2
...
Wrong number of loop variables
    Check test and failed loop    ${TEST_NAME} 1
    Check test and failed loop    ${TEST_NAME} 2
...
Empty body
    Check test and failed loop    ${TEST_NAME}
...
Invalid loop variable
    Check test and failed loop    ${TEST_NAME} 1
    Check test and failed loop    ${TEST_NAME} 2
    Check test and failed loop    ${TEST_NAME} 3
    Check test and failed loop    ${TEST_NAME} 4
    Check test and failed loop    ${TEST_NAME} 5
    Check test and failed loop    ${TEST_NAME} 6
